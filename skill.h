...
enum ESkillIndexes
{
	...
	SKILL_PASSIVE_MONSTERS = 201,
	SKILL_PASSIVE_HP = 202,
	SKILL_PASSIVE_RHH = 203,
	SKILL_PASSIVE_HH = 204,
	SKILL_PASSIVE_RESIS_CRIT = 205,
	SKILL_PASSIVE_RESIS_PERF = 206,
	SKILL_PASSIVE_DROP = 207,
#endif
