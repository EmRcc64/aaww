...
class CMapOutdoor : public CMapBase
{
	...
	public:
		...
		void			LoadDepthTerrainTexture(const char* textureName, IDirect3DTexture9** texture);
...
public:
		...
		LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderTerrain4 = nullptr;
		LPDIRECT3DVERTEXSHADER9 m_lpVertexShaderTerrainBase = nullptr;
		...
		LPDIRECT3DVERTEXSHADER9 m_lpShadowMapVertexShaderTree = nullptr;
		...
		LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderTerrain4 = nullptr;
		...
		LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderDepthTree = nullptr;
		LPDIRECT3DPIXELSHADER9 m_lpShadowMapPixelShaderTree = nullptr;
		LPDIRECT3DPIXELSHADER9 m_lpPixelShaderTerrainBase = nullptr;
		...
		LPDIRECT3DPIXELSHADER9 LoadAndBuildPixelShader(const char* filename, bool HLSL = true);
