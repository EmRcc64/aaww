...
PyObject * itemSelectItem(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (iIndex != 0 && !CItemManager::Instance().SelectItemData(iIndex))
	{
...
PyObject * itemCanAddToQuickSlotItem(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (CItemData::ITEM_TYPE_USE == pItemData->GetType() || CItemData::ITEM_TYPE_QUEST == pItemData->GetType() || iSubType == CItemData::ARMOR_SHIELD)
	{
		return Py_BuildValue("i", TRUE);
	}
