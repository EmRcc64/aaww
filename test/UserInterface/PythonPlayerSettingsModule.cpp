...
const bool CPlayerSettingsModule::LoadInitData()
{
	...
	static const std::vector<TEffect> m_vecEffectData =
	{
		...
		{ pkBase.EFFECT_SHINSOO, "", "d:/ymir work/effect/world/shinsoo_select.mse" },
		{ pkBase.EFFECT_TARGET_SHINSOO, "", "d:/ymir work/effect/world/shinsoo_glow_select.mse" },
		{ pkBase.EFFECT_CHUNJO, "", "d:/ymir work/effect/world/chunjo_select.mse" },
		{ pkBase.EFFECT_TARGET_CHUNJO, "", "d:/ymir work/effect/world/chunjo_glow_select.mse" },
		{ pkBase.EFFECT_JINNOS, "", "d:/ymir work/effect/world/jinnos_select.mse" },
		{ pkBase.EFFECT_TARGET_JINNOS, "", "d:/ymir work/effect/world/jinnos_glow_select.mse" },
		{ pkBase.EFFECT_MONSTER, "", "d:/ymir work/effect/world/mob_select.mse" },
		{ pkBase.EFFECT_TARGET_MONSTER, "", "d:/ymir work/effect/world/mob_glow_select.mse" },
		...
		{ pkBase.EFFECT_METIN_QUEUE, "Bip01", "d:/ymir work/effect/etc/metin_queue.mse"},
		...
		{ pkBase.EFFECT_TALISMAN_EQUIP_FIRE, "", "d:/ymir work/talisman/effect/talismano_fuoco.mse"},
		{ pkBase.EFFECT_TALISMAN_EQUIP_ICE, "", "d:/ymir work/talisman/effect/talismano_ghiaccio.mse"},
		{ pkBase.EFFECT_TALISMAN_EQUIP_WIND, "", "d:/ymir work/talisman/effect/talismano_vento.mse"},
		{ pkBase.EFFECT_TALISMAN_EQUIP_EARTH, "", "d:/ymir work/talisman/effect/talismano_terra.mse"},
		{ pkBase.EFFECT_TALISMAN_EQUIP_DARK, "", "d:/ymir work/talisman/effect/talismano_oscuro.mse"},
		{ pkBase.EFFECT_TALISMAN_EQUIP_ELEC, "", "d:/ymir work/talisman/effect/talismano_lampo.mse"},
...
const bool CPlayerSettingsModule::LoadGameEffect()
{
	...
	snprintf(GM_MARK, sizeof(GM_MARK), "d:/ymir work/effect/gm.mse");
...
#ifdef ENABLE_9TH_SKILL
		{ pkBase.EFFECT_AFFECT + 45, "", "d:/ymir work/pc/shaman/effect/chunwoon_4_target.mse"},
		{ pkBase.EFFECT_AFFECT + 46, "Bip01", "d:/ymir work/pc/shaman/effect/chunwoon_moojuk.mse"},
#endif
...
#endif
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
		{ pkBase.EFFECT_ACCE_BACK, "Bip01", "d:/ymir work/pc/common/effect/armor/acc_01.mse" },
#endif
...
#endif
		{ pkBase.EFFECT_EMOTICON + 25, "", "d:/ymir work/effect/etc/buff/1_muerte.mse" },
		{ pkBase.EFFECT_EMOTICON + 26, "", "d:/ymir work/effect/etc/buff/doble_muerte.mse" },
		{ pkBase.EFFECT_EMOTICON + 27, "", "d:/ymir work/effect/etc/buff/triple_muerte.mse" },
		{ pkBase.EFFECT_EMOTICON + 28, "", "d:/ymir work/effect/etc/buff/exterminio.mse" },
		{ pkBase.EFFECT_EMOTICON + 29, "", "d:/ymir work/effect/etc/buff/muertacular.mse" },
		{ pkBase.EFFECT_EMOTICON + 30, "", "d:/ymir work/effect/etc/buff/bestialidad.mse" },
		{ pkBase.EFFECT_EMOTICON + 31, "", "d:/ymir work/effect/etc/buff/salvajada.mse" },
		{ pkBase.EFFECT_EMOTICON + 32, "", "d:/ymir work/effect/etc/buff/catastrofe.mse" },
		{ pkBase.EFFECT_EMOTICON + 33, "", "d:/ymir work/effect/etc/buff/apocalipsis.mse" },
		{ pkBase.EFFECT_EMOTICON + 34, "", "d:/ymir work/effect/etc/buff/lluvia_muertos.mse" },
		{ pkBase.EFFECT_EMOTICON + 35, "", "d:/ymir work/effect/etc/buff/super_increible.mse" },
...
#ifdef ENABLE_EXPRESSING_EMOTION
		{ pkMotionManager.NAME_PUSH_UP, "pushup.msa", 0 },
...
{
	const char* path1 = "d:/ymir work/pc/warrior/";
	const char* path2 = "d:/ymir work/pc2/warrior/";
	CPlayerSettingsModule::LoadGameWarrior(CPlayerSettingsModule::RACE_WARRIOR_M, const_cast<char*>(path1));
	CPlayerSettingsModule::LoadGameWarrior(CPlayerSettingsModule::RACE_WARRIOR_W, const_cast<char*>(path2));
	return Py_BuildNone();
}

PyObject* cpsmLoadGameAssassin(PyObject* poSelf, PyObject* poArgs)
{
	const char* path1 = "d:/ymir work/pc/assassin/";
	const char* path2 = "d:/ymir work/pc2/assassin/";
	CPlayerSettingsModule::LoadGameAssassin(CPlayerSettingsModule::RACE_ASSASSIN_W, const_cast<char*>(path1));
	CPlayerSettingsModule::LoadGameAssassin(CPlayerSettingsModule::RACE_ASSASSIN_M, const_cast<char*>(path2));
	return Py_BuildNone();
}

PyObject* cpsmLoadGameSura(PyObject* poSelf, PyObject* poArgs)
{
	const char* path1 = "d:/ymir work/pc/sura/";
	const char* path2 = "d:/ymir work/pc2/sura/";
	CPlayerSettingsModule::LoadGameSura(CPlayerSettingsModule::RACE_SURA_M, const_cast<char*>(path1));
	CPlayerSettingsModule::LoadGameSura(CPlayerSettingsModule::RACE_SURA_W, const_cast<char*>(path2));
	return Py_BuildNone();
}

PyObject* cpsmLoadGameShaman(PyObject* poSelf, PyObject* poArgs)
{
	const char* path1 = "d:/ymir work/pc/shaman/";
	const char* path2 = "d:/ymir work/pc2/shaman/";
	CPlayerSettingsModule::LoadGameShaman(CPlayerSettingsModule::RACE_SHAMAN_W, const_cast<char*>(path1));
	CPlayerSettingsModule::LoadGameShaman(CPlayerSettingsModule::RACE_SHAMAN_M, const_cast<char*>(path2));
	return Py_BuildNone();
}
...
{
	const char* path1 = "d:/ymir work/pc3/wolfman/";
	CPlayerSettingsModule::LoadGameWolfman(CPlayerSettingsModule::RACE_WOLFMAN_M, const_cast<char*>(path1));
	return Py_BuildNone();
}
#endif // ENABLE_WOLFMAN_CHARACTER
