...
void CHARACTER::StateFlag()
{
	...
	//f.m_pkChrFind->AddAffect(AFFECT_WAR_FLAG, POINT_MOV_SPEED, 50 - f.m_pkChrFind->GetPoint(POINT_MOV_SPEED), 0, INFINITE_AFFECT_DURATION, 0, false); //@fixme1078
	f.m_pkChrFind->UpdatePacket(); //@fixme1078
...
void CHARACTER::StateHorse()
{
	...
	float	RESPAWN_DISTANCE = 2000.0f;
