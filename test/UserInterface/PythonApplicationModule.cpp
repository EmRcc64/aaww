...
{
	char* func;
	if (!PyTuple_GetString(poArgs, 0, &func))
		return Py_BuildException();
	...
	ShellExecute(NULL, func, name, NULL, NULL, SW_NORMAL);
	return Py_BuildNone();
}
...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_SWITCHER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_SWITCHER", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXTEND_SOCKET_5", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTEND_SOCKET_5", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "METINSTONES_QUEUE", 1);
#else
	PyModule_AddIntConstant(poModule, "METINSTONES_QUEUE", 0);
#endif

#if defined(ENABLE_NEW_AUTOPOTION)
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_AUTOPOTION", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_AUTOPOTION", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_PREMIUM_SYSTEM", 1);
	#ifdef ENABLE_PREMIUM_EFFECT_ABOVE_HEAD
		PyModule_AddIntConstant(poModule, "ENABLE_PREMIUM_EFFECT_ABOVE_HEAD", 1);
	#else
		PyModule_AddIntConstant(poModule, "ENABLE_PREMIUM_EFFECT_ABOVE_HEAD", 0);
	#endif
#else
	PyModule_AddIntConstant(poModule, "ENABLE_PREMIUM_SYSTEM",	0);
#endif
...
#ifdef ENABLE_9THSKILL
	PyModule_AddIntConstant(poModule, "ENABLE_9THSKILL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_9THSKILL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__MAINTENANCE__", 1);
#else
	PyModule_AddIntConstant(poModule, "__MAINTENANCE__", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_WAR_MAP_PVP_TACT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_WAR_MAP_PVP_TACT", 0);
#endif
...
#ifdef ENABLE_BUTTON_EVENTS
	PyModule_AddIntConstant(poModule, "ENABLE_BUTTON_EVENTS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BUTTON_EVENTS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_DUNGEON_COOL_TIME", 1);
#endif

#ifdef ENABLE_DUNGEON_EVENT_TIMER
	PyModule_AddIntConstant(poModule, "ENABLE_DUNGEON_EVENT_TIMER",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DUNGEON_EVENT_TIMER",	0);
#endif

#ifdef BESTPRODUCTION_BOT_KONTROL_SYSTEM
	PyModule_AddIntConstant(poModule, "BESTPRODUCTION_BOT_KONTROL_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "BESTPRODUCTION_BOT_KONTROL_SYSTEM", 0);
#endif
