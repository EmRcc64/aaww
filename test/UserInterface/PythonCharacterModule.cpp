...
PyObject * chrAttachEffectByID2(PyObject* poSelf, PyObject* poArgs)
{
	int iParentPartIndex;
	if (!PyTuple_GetInteger(poArgs, 0, &iParentPartIndex))
		return Py_BuildException();
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "AttachEffectByID2",			chrAttachEffectByID2,				METH_VARARGS },
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_THIEF_GLOVES_STONES", CInstanceBase::NEW_AFFECT_THIEF_GLOVES_STONES);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_THIEF_GLOVES_BOSS", CInstanceBase::NEW_AFFECT_THIEF_GLOVES_BOSS);
#endif

	PyModule_AddIntConstant(poModule, "AFFECT_SINGLE_BONUS_URIEL", CInstanceBase::AFFECT_SINGLE_BONUS_URIEL);
...
#if defined(ENABLE_CONQUEROR_LEVEL) && defined(ENABLE_9THSKILL)
	...
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_ATTACK_SPEED_RECOVERY", CInstanceBase::AFFECT_AUTO_ATTACK_SPEED_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_MOV_SPEED_RECOVERY", CInstanceBase::AFFECT_AUTO_MOV_SPEED_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_CRITICAL_RECOVERY", CInstanceBase::AFFECT_AUTO_CRITICAL_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_PENETRATE_RECOVERY", CInstanceBase::AFFECT_AUTO_PENETRATE_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_VIT_RECOVERY", CInstanceBase::AFFECT_AUTO_VIT_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_STR_RECOVERY", CInstanceBase::AFFECT_AUTO_STR_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_INT_RECOVERY", CInstanceBase::AFFECT_AUTO_INT_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_DEX_RECOVERY", CInstanceBase::AFFECT_AUTO_DEX_RECOVERY);

	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_RED_POTION_RECOVERY", CInstanceBase::AFFECT_AUTO_RED_POTION_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_ORANGE_POTION_RECOVERY", CInstanceBase::AFFECT_AUTO_ORANGE_POTION_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_YELLOW_POTION_RECOVERY", CInstanceBase::AFFECT_AUTO_YELLOW_POTION_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_GREEN_POTION_RECOVERY", CInstanceBase::AFFECT_AUTO_GREEN_POTION_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_BLUE_POTION_RECOVERY", CInstanceBase::AFFECT_AUTO_BLUE_POTION_RECOVERY);
	PyModule_AddIntConstant(poModule, "AFFECT_AUTO_WHITE_POTION_RECOVERY", CInstanceBase::AFFECT_AUTO_WHITE_POTION_RECOVERY);
#endif
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POLYMORPH",				CInstanceBase::NEW_AFFECT_POLYMORPH); //ENABLE_AFFECT_POLYMORPH_REMOVE

#ifdef ENABLE_DUNGEON_COOL_TIME
	PyModule_AddIntConstant(poModule, "AFFECT_SHADOW_POTION", CInstanceBase::AFFECT_SHADOW_POTION);
#endif
