...
DWORD CActorInstance::AttachEffectByID2(DWORD dwParentPartIndex, const char * c_pszBoneName, DWORD dwEffectID, const D3DXVECTOR3 * c_pv3Position, float fParticleScale, const D3DXVECTOR3* c_pv3MeshScale)
{
	TAttachingEffect ae;
	ae.iLifeType = EFFECT_LIFE_INFINITE;
	ae.dwEndTime = 0;
